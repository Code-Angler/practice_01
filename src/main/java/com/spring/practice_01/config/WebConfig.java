package com.spring.practice_01.config;

import com.spring.practice_01.config.auth.LoginUserArgumentResolver;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://front.blossomwhale.shop","http://localhost:3000")
